...
For every row, after updating `heights`, compute the largest rectangle in that histogram (same problem as `largest-rectangle/`). Take the max over all rows.
