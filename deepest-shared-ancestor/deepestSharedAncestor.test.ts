...
import {
  TreeNode,
  deepestSharedAncestor,
} from "./deepestSharedAncestor";
...
describe("deepestSharedAncestor", () => {
  ...
  it("p equals q returns p", () => {
    ...
    const lca = deepestSharedAncestor(root, p, p);
  ...
  it("duplicate values: matches by node identity", () => {
    ...
    const lca = deepestSharedAncestor(root, left5, right5);
  ...
  it("right-skewed tree", () => {
    ...
    const lca = deepestSharedAncestor(root, two, three);
